      ...
      <div className="space-y-3">
        {bookings.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-200">
            <div className="w-14 h-14 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-500 mx-auto mb-3">
            ...
            <Link href="/dashboard/browse">
              <Button className="h-10 px-6 bg-emerald-500 hover:bg-emerald-600 text-white font-medium rounded-lg text-sm">
                Browse Courts
              </Button>
            </Link>
          </div>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      <div className="flex">
        ...
        <div className="flex-1 p-3 sm:p-4 min-w-0">
          ...
          <div className="flex items-center justify-between">
            <span className="text-base font-bold text-emerald-500">${booking.total_price.toFixed(2)}</span>
            ...
            <div className="flex gap-2">
              ...
              {booking.status === 'completed' && (
                <Link href="/dashboard/browse" className="h-8 px-3 flex items-center gap-1 bg-gray-900 hover:bg-emerald-500 text-white text-xs font-medium rounded-lg transition-colors">
                  Book Again
