  ...
  return (
    <div className="pb-20 space-y-6 sm:space-y-8">
      ...
      <Link href="/dashboard/browse" className="block">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 p-5 sm:p-6 text-white shadow-lg shadow-orange-200 cursor-pointer hover:shadow-xl transition-all">
