          ...
          <>
            ...
            <div className="absolute top-14 right-4 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 animate-in slide-in-from-top-2">
              <div className="px-4 py-3 border-b border-gray-100">
                ...
                <span className="inline-block mt-1 px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded-full uppercase">
                  {user.role?.replace('_', ' ')}
                </span>
              </div>
              <Link
                ...
                className="flex items-center gap-3 px-4 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-emerald-500 transition-colors"
              >
